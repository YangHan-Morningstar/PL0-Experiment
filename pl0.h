...
#define nameTableCapacity 100   /* 名字表容量 */
#define nmax 14     /* number的最大位数 */
#define al 10       /* 符号的最大长度 */
#define amax 2047   /* 地址上界*/
#define maxNestLevelNum 3    /* 最大允许过程嵌套声明层数 [0,  maxNestLevelNum]*/
#define maxVirtualMachineCodeNum 500   /* 最多的虚拟机代码数 */
...
struct instruction virtualCode[maxVirtualMachineCodeNum]; /* 存放虚拟机代码的数组 */
...
int constdeclaration(int* nameTableTailPointer, int lev, int* nameRelativeAddress);
